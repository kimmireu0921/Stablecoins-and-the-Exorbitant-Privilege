...
notes(sld,
    ...
    "UST was an algorithmic stablecoin — it had no real dollar reserves whatsoever. "
    "Its one-dollar peg was maintained purely by a mathematical relationship with its sister token LUNA. "
    ...
    "Now, the 5 to 8 percent buffer we are talking about has nothing to do with UST — "
    "UST had zero reserves. That number refers to Tether. "
    "Tether and Circle had nothing to do with Terra's collapse. Their reserves are real assets. "
    "But markets panicked — investors began asking: what if all stablecoins are fragile? "
    "This caused a wave of redemptions hitting Tether specifically. "
    "Here is where the buffer condition becomes decisive. "
    "Tether held only about 5 to 8 percent of its reserves in liquid cash at the time — "
    "the rest was in Treasury bills. So when redemption demand came in, "
    "Tether could not pay from cash alone. It had to sell Treasury bills quickly to raise the dollars. "
    "That forced selling pushed T-bill yields above OIS, and the spread spiked. "
...
notes(sld,
    ...
    "Circle disclosed that 3.3 billion dollars — about 8 percent of its total 41 billion in reserves — "
    "were held at SVB and temporarily inaccessible. "
    "USDC depegged to around 87 cents, which is actually a larger nominal depeg than Tether in 2022. "
    "So why does the CAR go to minus 18 instead of spiking upward like the 2022 events? "
    "The key difference is not that Circle had a comfortable cash buffer — "
    "in fact, 8 percent of its reserves were frozen. "
    "The difference is that U.S. regulators stepped in and guaranteed all SVB deposits within 72 hours. "
    "Circle never had to sell a single Treasury bill because the crisis was resolved by government intervention "
    "before any forced liquidation became necessary. "
    "At the same time, SVB's collapse triggered a massive market-wide flight to safety. "
    "Investors across the financial system rushed to buy U.S. Treasury bills — "
    ...
    "No forced selling from Circle, plus strong flight-to-safety buying from the broader market — "
    "those two forces together produced the deeply negative CAR we observe.")
